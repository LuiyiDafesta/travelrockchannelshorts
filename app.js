...
async function fetchVideosAndComments() {
  try {
    ...
    state.videos = (videos || []).map(v => ({
      ...
      videoUrl: v.video_url ? v.video_url.replace('https://f004.backblazeb2.com/file/', 'https://media.supertourchannel.com.ar/') : '',
      thumbnailUrl: v.thumbnail_url ? v.thumbnail_url.replace('https://f004.backblazeb2.com/file/', 'https://media.supertourchannel.com.ar/') : '',
      likes: v.likes,
      duration: v.duration,
      date: v.date,
